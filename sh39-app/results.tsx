...
// Types aligned with article screen
type HeadingBlock = {
  type: 'heading'
  text: string
  level: number
...
function buildArticleText(article: ArticleData): { rawText: string; lowerText: string } {
  const pieces: string[] = []
...
export default function SearchResultsScreen() {
  ...
  const allSearchableArticles: InternalSearchableArticle[] = useMemo(() => {
    return Object.entries(allArticles).map(([slug, article]) => {
